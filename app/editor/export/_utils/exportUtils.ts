...
export interface ExportConfig {
    ...
    language?: string;
    copyright?: string;
    foreword?: string; // HTML
    afterword?: string; // HTML
    includeTOC?: boolean;
}
...
const generateHtmlContent = (chapters: ChapterData[], config: ExportConfig) => {
    ...
    // Toc matches chapters in PDF usually auto-generated by readers, but we can fake one.
...
export const exportToEpub = async (chapters: ChapterData[], config: ExportConfig) => {
   // epub-gen-memory expects separate chapters
   const epubOptions = {
       title: config.title,
